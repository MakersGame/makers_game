...
func _ready():
    ...
    $AreaBlocks/Home/Enermies/Enermy.init("test_enermy",Vector2(-1,0))
    $AreaBlocks/Home/Enermies/Enermy2.init("test_enermy",Vector2(-1,0))
    $AreaBlocks/Home/Enermies/Enermy3.init("test_enermy",Vector2(0,-1))
